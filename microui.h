#ifndef MICRO_UI_H_INCLUDED_
#define MICRO_UI_H_INCLUDED_
#pragma once

#include "muconfig.h"

#define MU_VERSION "2.0.1"
#define MU_VERSION_MAJ 2
#define MU_VERSION_PAT 0
#define MU_VERSION_MIN 1
